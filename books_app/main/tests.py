...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        post_data = {
            'name':"Dave",
            'biography':"Dave is a new author"
        }

        self.app.post('/create_author', data=post_data)
        # TODO: Verify that the author was updated in the database
        author = Author.query.filter_by(name="Dave").one()
        self.assertIsNotNone(author)
        self.assertEqual(author.name, "Dave")
        self.assertEqual(author.biography, "Dave is a new author")
